...
// Type: Envelope.WcfUtils.Saml2.Messages.EncryptedElementType
...
namespace Envelope.WcfUtils.Saml2.Messages
{
  ...
  public class EncryptedElementType
  {
    ...
    {
      get => this.encryptedDataField;
      set => this.encryptedDataField = value;
    }
    ...
    {
      get => this.encryptedKeyField;
      set => this.encryptedKeyField = value;
    }
  }
}
